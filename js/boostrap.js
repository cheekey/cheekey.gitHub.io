...
define("angular", ["zepto"], (function (global) {
    return function () {
        var ret, fn;
...
define("ngResource", ["angular"], function(){});
...
define("ngProgress", ["angular"], function(){});
...
define('app',[  
        ...
        var app = angular.module('app', ['states','ngResource','ngProgress','controllers', 'services']);  
...
define('apps/home/states/states',['apps/common/states/states'],function(states){
  states.config(['$stateProvider','$urlRouterProvider',function($stateProvider,$urlRouterProvider){
        $stateProvider.state('home', {
            url: '/',
            templateUrl:"/public/assets/js/apps/home/templates/home.html",
            controller:'home'
        })
...
define('apps/home/states/_base',[
    'apps/home/states/states'
],function(){});
define('apps/home/controllers/controllers',['apps/common/controllers/controllers'],function(controllers){
    controllers.controller('home',['$scope',function($scope){
        // $scope.open = function(){
        //   var newopen = $modal.open({
        //     templateUrl:'/public/assets/js/apps/home/templates/nav.html',
        //     controller:'one',
        //     resolve:{}
        //   })
        // }
...
define('apps/home/controllers/home',['app'],function(controller){
    controller.controller("one",function($scope){alert(1)
        $scope.a = {b:'0000000000'}
    })
});
define('apps/home/controllers/_base',[
    'apps/home/controllers/controllers',
    'apps/home/controllers/home'
],function(){});
define('apps/home/services/services',['apps/common/services/services'], function (services) {
    services.factory('home', ['$resource',function($resource){
        return $resource('', {id:'@id'}, {
            'save': {method: 'POST', url: ''}
        });
    }]);
});
define('apps/home/services/_base',[
    'apps/home/services/services'
],function(){});
define('apps/home/main',[
    'apps/home/states/_base',
    'apps/home/controllers/_base',
    'apps/home/services/_base'
], function(){});
// //author key
